...
var singleChild = function(children) {
  return (Fake(null, children)).props.children;
};

var multiChild = function(child1, child2, child3, child4) {
  return (Fake(null, child1, child2, child3,child4)).props.children;
};
...
describe('ReactComponentFlatten', function() {
  ...
  it("should reuse a flat array", function() {
    var children = [
      React.DOM.div( {key:"foo"} ),
      React.DOM.div( {key:"bar"} )
    ];
  ...
  it("cannot keep keys unique when children are unboxed", function() {
    ...
    var children1 = [React.DOM.div( {key:"foo"} )];
    var children2 = [React.DOM.div( {key:"foo"} )];
